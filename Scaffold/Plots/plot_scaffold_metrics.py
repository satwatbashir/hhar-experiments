#!/usr/bin/env python3
"""
Generate a 2x2 overview plot from federated SCAFFOLD metrics CSVs.
"""
...
def make_overview_plot(
    ...
    """Create a 2x2 overview plot of SCAFFOLD metrics."""
...
def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Generate SCAFFOLD overview plots from metrics CSVs.")
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if not title:
        ...
        title = f"SCAFFOLD Overview — {exp_name}"
